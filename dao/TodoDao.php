...
final class TodoDao {
    ...
    public function getAll() {
        $row = $this->query('select * from todo', PDO::FETCH_ASSOC)->fetchAll();
        return $row;
    }
    ...
    private function insert(Todo $todo) {
        ...
        $sql = '
            INSERT INTO todo (id, priority, created_on, last_modified_on, due_on, title, description, comment, status, deleted,pain,substance)
                VALUES (:id, :priority, :created_on, :last_modified_on, :due_on, :title, :description, :comment, :status, :deleted, :pain, :substance)';
    ...
    public function enumDropdown($table_name, $column_name, $echo = false)
{
   $selectDropdown = "<select name=\"$column_name\">";
   $sql = "SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS
       WHERE TABLE_NAME = 'todo' AND COLUMN_NAME = 'status'";
   $row = $this->query($sql);
